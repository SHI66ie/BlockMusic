...
class MusicNFT:
    class View:
        def artistVerified(artist: Address) -> bool: ...
        def owner() -> Address: ...
        def genLayerModerator() -> Address: ...
        def balanceOf(owner: Address) -> u256: ...
        def ownerOf(tokenId: u256) -> Address: ...
        def totalSupply() -> u256: ...
        def getArtistEarnings(artist: Address) -> (u256, u256): ...
        def getMusicMetadata(tokenId: u256) -> str: ...
        def getSamples(tokenId: u256) -> str: ...
        def getMintFee() -> u256: ...
        def version() -> str: ...
    class Write:
        def setArtistVerification(artist: Address, status: bool) -> None: ...
